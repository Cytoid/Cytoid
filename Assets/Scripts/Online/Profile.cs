...
public class FullProfile : Profile
{
    ...
    [JsonProperty("qualifiedLevelCount")] public int QualifiedLevelCount { get; set; }
    [JsonProperty("qualifiedLevels")] public List<OnlineLevel> QualifiedLevels { get; set; } = new List<OnlineLevel>();
