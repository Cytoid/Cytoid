Shader "Cytus/SpriteSpriteTilingProgress"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				u_xlat0 = 0.005 + i.t1.y - _Start;
				u_xlatb0 = u_xlat0<0.0;
				u_xlat1 = -0.005 - i.t1.y + _End;
				u_xlatb1 = u_xlat1<0.0;
				if((int(u_xlatb0) * int(0xffffffffu))!=0||int(u_xlatb1) * int(0xffffffffu)!=0){discard;}
