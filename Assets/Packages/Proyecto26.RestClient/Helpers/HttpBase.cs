...
namespace Proyecto26
{
    public static class HttpBase
    {
        ...
        {
            return new RequestException(request.error, request.isHttpError, request.isNetworkError, request.responseCode, /*request.downloadHandler.text*/"no response lol");
        }
