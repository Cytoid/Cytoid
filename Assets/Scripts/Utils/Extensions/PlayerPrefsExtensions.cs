...
public static class PlayerPrefsExtensions
{
    ...
    {
        PlayerPrefs.SetString(key, "#" + ColorUtility.ToHtmlStringRGB(color));
    }
    
    public static void SetColor(string key, string color)
    {
    ...
    {
        return PlayerPrefs.GetString(key).ToColor();
    }
